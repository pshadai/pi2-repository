				...
				<fieldset>
					...
					<form action='<c:url value="/login.jsp"></c:url>' method="post">
						...
						<div class="form-group has-success has-error has-feedback">
							...
							<input type="text" id="cpf"	class="form-control" placeholder="Digite o Cpf"	required="required"	aria-describedby="inputSuccess2Status inputError2Status" name="cpf" />
						...
						<div class="form-group">
							...
							<input type="password" id="senha" class="form-control" placeholder="Digite a senha"	required="required" name="password" />
						</div>
